...
public static class DisplayFusionFunction
{
  public static void Run(IntPtr windowHandle)
  {
    ...
    if (windowBounds.X + windowBounds.Width != monitorBounds.X + monitorBounds.Width)
    {
    ...
    {
      BFS.Window.SetSizeAndLocation(windowHandle, monitorBounds.Left + percent_33, monitorBounds.Top, percent_67, monitorBounds.Height);
      return;
    }
    else if(IsWithin(windowBounds.Width, percent_67, 5))
    {
      BFS.Window.SetSizeAndLocation(windowHandle, monitorBounds.Left + percent_67, monitorBounds.Top, percent_33, monitorBounds.Height);
      return;
    }
