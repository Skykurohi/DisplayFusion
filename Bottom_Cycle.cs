...
public static class DisplayFusionFunction
{
  public static void Run(IntPtr windowHandle)
  {
    ...
    if(IsWithin(windowBounds.Height, percent_50, 5)) {
      BFS.Window.SetSizeAndLocation(windowHandle, monitorBounds.Left, monitorBounds.Top + percent_33, monitorBounds.Width, percent_67);
      return;
    }
    else if(IsWithin(windowBounds.Height, percent_67, 5)) {
      BFS.Window.SetSizeAndLocation(windowHandle, monitorBounds.Left, monitorBounds.Top + percent_67, monitorBounds.Width, percent_33);
      return;
    }
